...
export default function About(props) {
    ...
    <Layout className={aboutStyles.aboutPage} gridClass={aboutStyles.grid} context={props.pageContext}>
      ...
      <main>
        <div className={aboutStyles.aboutMain}>
          <div className={aboutStyles.aboutWrapper + ' ' + aboutStyles.genericHeadings}>
  ...
  The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Regard s.r.o., Na Dolnici 2674/1a, Prague 13.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to Regard, accessible from <a href="regard.cz" rel="external nofollow noopener noreferrer" target="_blank">regard.cz</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>By visiting this page on our website: <a href="regard.cz/about" rel="external nofollow noopener" target="_blank">regard.cz/about</a></li>
            </ul>
